  ...
  quickLinks = [
    {
      ...
      link: mdcsRoutes?.report?.dailyReport,
    },
    {
      desc: 'Exception List',
      link: mdcsRoutes?.bus?.busExpList,
    },
    {
      desc: 'Add New Bus Entry',
      link: mdcsRoutes?.bus?.vehicleList,
    },
    {
      desc: 'Parameters View',
      link: mdcsRoutes?.parameterManagement?.parameterViewer,
    },
    {
      desc: 'Add Hoc Report',
      link: mdcsRoutes?.report?.adhoc,
    },
  ];
