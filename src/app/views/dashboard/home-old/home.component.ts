...
import { mdcsRoutes } from '@app/app.routes';
import { IDepoList } from '@models/depo';
import { AuthService } from '@services/auth.service';
import { DepoService } from '@services/depo.service';

// eslint-disable-next-line @typescript-eslint/no-explicit-any
const routes: any = mdcsRoutes;
  ...
  quickLinks = [
    {
      ...
      link: routes?.report?.dailyReport,
    },
    {
      desc: 'Exception List',
      link: routes?.bus?.busExpList,
    },
    {
      desc: 'Add New Bus Entry',
      link: routes?.bus?.vehicleList,
    },
    {
      desc: 'Parameters View',
      link: routes?.parameterManagement?.parameterViewer,
    },
    {
      desc: 'Ad-Hoc Report',
      link: routes?.report?.adhoc,
    },
  ];
