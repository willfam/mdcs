...
describe('SystemInformationComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    providers: [MaintenanceSharedService, provideHttpClient(withInterceptorsFromDi()), provideHttpClientTesting(), { provide: AuthService, useValue: jasmine.createSpyObj('AuthService', ['isDagw']) }]
}).compileComponents();
  }));
