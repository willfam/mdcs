...
export class ReportService {
  ...
  getReportURL(reportFileName: string, params: string): string {
    if (environment.useDummyData) {
      return `https://ec2-13-250-26-197.ap-southeast-1.compute.amazonaws.com/ReportServer/Pages/ReportViewer.aspx?/BusArrivalExceptionReport&rs:Embed=true&rs:Format=HTML5&rs:Command=Render&rc:Toolbar=true&rc:Parameters=false&SPId=16&BusinessDay=2026-03-04&DepotId=970&Username=daily-report`;
    }
