...
import { DepotOverViewComponent } from './views/dashboard/depot-over-view/depot-over-view.component';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: mdcsRoutes?.dashboard?.depotOverView,
        component: DepotOverViewComponent,
        canActivate: [RoleGuard],
        data: {
          roles: MENU_ACCESS.mdcs.dashboard.depotOverView.view,
          title: 'Dashboard - Depot',
        },
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './views/message-data-management/message-file-import/message-file-import.component'
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './views/message-data-management/message-file-export/message-file-export.component'
