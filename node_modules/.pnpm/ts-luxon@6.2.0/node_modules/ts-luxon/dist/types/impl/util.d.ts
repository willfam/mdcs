...
export declare function roundTo(value: number, digits: number, rounding?: ToRelativeOptions["rounding"]): number;
...
export declare function parseZoneInfo(ts: number, offsetFormat?: Intl.DateTimeFormatOptions["timeZoneName"], locale?: string, timeZone?: string): string;
