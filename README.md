...
└── 📁src
    └── 📁app
        ...
        └── 📁views
            └── 📁bus
                └── 📁daily-bus-list
                    └── 📁search
                        ...
                        └── bus-search.component.scss
                        └── bus-search.component.spec.ts
            ...
            └── 📁monitoring
                └── 📁bus-operation
                    └── bus-operation.component.html
                    └── bus-operation.component.scss
                    └── bus-operation.component.spec.ts
                    └── bus-operation.component.ts
        └── app.component.html
        └── app.component.scss
        └── app.component.ts
        └── app.routes.ts
